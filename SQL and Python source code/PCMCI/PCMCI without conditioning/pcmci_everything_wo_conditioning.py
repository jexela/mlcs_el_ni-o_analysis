...
for i in range(0,number_of_gridpoints):
  ...
  df = pd.read_csv(r"C:\Users\Alexej\Desktop\Bachelorarbeit\climatology 1981-2010\PCMCI\causal_map_wo_conditioning\pcmci_nino12.csv", sep=';',skiprows=start,nrows=months)
...
numpy.savetxt("nino12_wo_conditioning.csv", coefficients_oni, delimiter=";")
