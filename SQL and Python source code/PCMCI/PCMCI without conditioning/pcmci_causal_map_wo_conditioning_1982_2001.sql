...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_oni_con_everything_1982_2001
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_oni_con_everything_1982_2001
(longditude real,
laditude real,
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_oni_wo_conditioning_1982_2001;
CREATE TABLE beta_coefficients_maps_precipitation_oni_wo_conditioning_1982_2001 as 
...
FROM casual_maps_wo_conditioning_precipitation_oni_con_everything_1982_2001 as b
...
FROM maxmin as m, standardization_1982_2001 as s, casual_maps_wo_conditioning_precipitation_oni_con_everything_1982_2001 as c  
...
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_oni_wo_conditioning_1982_2001 as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_oni_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_oni_wo_conditioning_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, b.coefficient_lag FROM beta_coefficients_maps_precipitation_oni_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_oni_wo_conditioning_lag_1982_2001.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_nino12_con_everything_1982_2001
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_nino12_con_everything_1982_2001
(longditude real,
laditude real,
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_nino12_wo_conditioning_1982_2001;
CREATE TABLE beta_coefficients_maps_precipitation_nino12_wo_conditioning_1982_2001 as 
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization_1982_2001 as s, casual_maps_wo_conditioning_precipitation_nino12_con_everything_1982_2001 as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning_1982_2001 as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;



\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino12_wo_conditioning_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, b.coefficient_lag FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino12_wo_conditioning_lag_1982_2001.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_tni_con_everything_1982_2001
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_tni_con_everything_1982_2001
(longditude real,
laditude real,
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_tni_wo_conditioning_1982_2001;
CREATE TABLE beta_coefficients_maps_precipitation_tni_wo_conditioning_1982_2001 as 
...
FROM casual_maps_wo_conditioning_precipitation_tni_con_everything_1982_2001 as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization_1982_2001 as s, casual_maps_wo_conditioning_precipitation_tni_con_everything_1982_2001 as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_tni_wo_conditioning_1982_2001 as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_tni_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_tni_wo_conditioning_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, b.coefficient_lag FROM beta_coefficients_maps_precipitation_tni_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_tni_wo_conditioning_lag_1982_2001.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_nino3_con_everything_1982_2001
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_nino3_con_everything_1982_2001
(longditude real,
laditude real,
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_nino3_wo_conditioning_1982_2001;
CREATE TABLE beta_coefficients_maps_precipitation_nino3_wo_conditioning_1982_2001 as 
...
FROM casual_maps_wo_conditioning_precipitation_nino3_con_everything_1982_2001 as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization_1982_2001 as s, casual_maps_wo_conditioning_precipitation_nino3_con_everything_1982_2001 as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning_1982_2001 as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino3_wo_conditioning_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, b.coefficient_lag FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino3_wo_conditioning_lag_1982_2001.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_nino4_con_everything_1982_2001
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_nino4_con_everything_1982_2001
(longditude real,
laditude real,
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_nino4_wo_conditioning_1982_2001;
CREATE TABLE beta_coefficients_maps_precipitation_nino4_wo_conditioning_1982_2001 as 
...
FROM casual_maps_wo_conditioning_precipitation_nino4_con_everything_1982_2001 as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization_1982_2001 as s, casual_maps_wo_conditioning_precipitation_nino4_con_everything_1982_2001 as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning_1982_2001 as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino4_wo_conditioning_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, b.coefficient_lag FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning_1982_2001 as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino4_wo_conditioning_lag_1982_2001.csv' DELIMITER ';' CSV HEADER;
