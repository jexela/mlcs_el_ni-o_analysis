...
DROP TABLE IF EXISTS blueshapes;

CREATE TABLE blueshapes (year,area) as (
...
\copy (SELECT b.* FROM blueshapes as b ORDER BY b.year) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/Benjamini_Hochberg/blueshapes.csv' DELIMITER ';' CSV HEADER;