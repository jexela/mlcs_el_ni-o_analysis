...
--Starting 1979-1988, the corresponding critical value r_c for a significance level  of alpha=0.05, for a two-tailed test is r_c=0.179 for n=120 (ten years). Observe that in this
--case, the null hypothesis is rejected if |r|>r_c=0.179.

SELECT t.longditude, t.laditude, CASE WHEN abs(t.correlation) < 0.179 THEN 0 ELSE t.correlation END
FROM(
SELECT o.longditude, o.laditude, corr(o.percipitation_anomaly,o.oni) as correlation
...
--\copy period_1979_1988 TO 'C:/Users/Alexej/Desktop/period_1979_1988.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_1984_1993 TO 'C:/Users/Alexej/Desktop/period_1984_1993.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_1989_1998 TO 'C:/Users/Alexej/Desktop/period_1989_1998.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_1994_2003 TO 'C:/Users/Alexej/Desktop/period_1994_2003.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_1999_2008 TO 'C:/Users/Alexej/Desktop/period_1999_2008.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_2004_2013 TO 'C:/Users/Alexej/Desktop/period_2004_2013.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_2009_2018 TO 'C:/Users/Alexej/Desktop/period_2009_2018.csv' DELIMITER ';' CSV HEADER;
...
--\copy period_2014_2021 TO 'C:/Users/Alexej/Desktop/period_2014_2021.csv' DELIMITER ';' CSV HEADER;
