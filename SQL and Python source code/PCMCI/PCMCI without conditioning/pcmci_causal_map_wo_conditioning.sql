...
\copy (SELECT d.precipitation_anomaly,d.oni FROM data_nino_indices as d ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/pcmci_oni.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_12_index FROM data_nino_indices as d ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/pcmci_nino12.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_3_index FROM data_nino_indices as d ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/pcmci_nino3.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_4_index FROM data_nino_indices as d ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/pcmci_nino4.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.tni FROM data_nino_indices as d ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/everything_without_nino34/pcmci_tni.csv' DELIMITER ';' CSV HEADER;

\copy (SELECT d.precipitation_anomaly,d.oni FROM data_nino_indices as d WHERE d.year BETWEEN 1982 AND 2001 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_oni_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_12_index FROM data_nino_indices as d WHERE d.year BETWEEN 1982 AND 2001 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_nino12_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_3_index FROM data_nino_indices as d WHERE d.year BETWEEN 1982 AND 2001 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_nino3_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_4_index FROM data_nino_indices as d WHERE d.year BETWEEN 1982 AND 2001 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_nino4_1982_2001.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.tni FROM data_nino_indices as d WHERE d.year BETWEEN 1982 AND 2001 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_tni_1982_2001.csv' DELIMITER ';' CSV HEADER;

\copy (SELECT d.precipitation_anomaly,d.oni FROM data_nino_indices as d WHERE d.year BETWEEN 2002 AND 2021 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_oni_2002_2021.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_12_index FROM data_nino_indices as d WHERE d.year BETWEEN 2002 AND 2021 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_nino12_2002_2021.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_3_index FROM data_nino_indices as d WHERE d.year BETWEEN 2002 AND 2021 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_nino3_2002_2021.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.nino_4_index FROM data_nino_indices as d WHERE d.year BETWEEN 2002 AND 2021 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_nino4_2002_2021.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT d.precipitation_anomaly,d.tni FROM data_nino_indices as d WHERE d.year BETWEEN 2002 AND 2021 ORDER BY d.laditude ASC,d.longditude ASC,d.year ASC, d.month ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/pcmci_tni_2002_2021.csv' DELIMITER ';' CSV HEADER;

------------------------------------------------------------------------------ONI -------------------------------------------------------------------------------------------------

--Prepare casual_maps_wo_conditioning_precipitation_oni_con_everything with the help of PCMCI algorithm

/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_oni_con_everything
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_oni_con_everything
(longditude real,
laditude real,
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_oni_wo_conditioning;
CREATE TABLE beta_coefficients_maps_precipitation_oni_wo_conditioning as 
...
FROM casual_maps_wo_conditioning_precipitation_oni_con_everything as b
...
FROM maxmin as m, standardization as s, casual_maps_wo_conditioning_precipitation_oni_con_everything as c  
...
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_oni_wo_conditioning as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_oni_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_oni_wo_conditioning.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients >= 0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients <= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_oni_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_oni_wo_conditioning_lag_red.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients <= -0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients >= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_oni_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_oni_wo_conditioning_lag_blue.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_nino12_con_everything
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_nino12_con_everything
(longditude real,
laditude real,
...
\copy casual_maps_wo_conditioning_precipitation_nino12_con_everything (longditude,laditude,nino12_coefficient_minus_zero_lag,nino12_coefficient_minus_one_lag,nino12_coefficient_minus_two_lag, nino12_coefficient_minus_three_lag,nino12_coefficient_minus_four_lag,nino12_coefficient_minus_five_lag, nino12_coefficient_minus_six_lag, nino12_coefficient_minus_seven_lag,nino12_coefficient_minus_eight_lag, nino12_coefficient_minus_nine_lag, nino12_coefficient_minus_ten_lag, nino12_coefficient_minus_eleven_lag, nino12_coefficient_minus_twelve_lag) FROM 'C:/Users/Alexej/nino12_wo_conditioning.csv' DELIMITER ';';
...
DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_nino12_wo_conditioning;
CREATE TABLE beta_coefficients_maps_precipitation_nino12_wo_conditioning as 
...
FROM casual_maps_wo_conditioning_precipitation_nino12_con_everything_1982_2001 as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization as s, casual_maps_wo_conditioning_precipitation_nino12_con_everything as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino12_wo_conditioning.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients >= 0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients <= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino12_wo_conditioning_lag_red.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients <= -0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients >= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_nino12_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino12_wo_conditioning_lag_blue.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_tni_con_everything
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_tni_con_everything
(longditude real,
laditude real,
...
FROM casual_maps_wo_conditioning_precipitation_tni_con_everything as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
          WHEN m.maximum = c.tni_coefficient_minus_zero_lag OR m.minimum = c.tni_coefficient_minus_zero_lag THEN 0
			...
			END as coefficient_lag
FROM maxmin as m, standardization as s, casual_maps_wo_conditioning_precipitation_tni_con_everything as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_tni_wo_conditioning as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_tni_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_tni_wo_conditioning.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients >= 0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients <= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_tni_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_tni_wo_conditioning_lag_red.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients <= -0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients >= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_tni_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_tni_wo_conditioning_lag_blue.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_nino3_con_everything
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_nino3_con_everything
(longditude real,
laditude real,
...
FROM casual_maps_wo_conditioning_precipitation_nino3_con_everything as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization as s, casual_maps_wo_conditioning_precipitation_nino3_con_everything as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino3_wo_conditioning.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients >= 0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients <= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino3_wo_conditioning_lag_red.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients <= -0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients >= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_nino3_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino3_wo_conditioning_lag_blue.csv' DELIMITER ';' CSV HEADER;
...
/*DROP TABLE IF EXISTS casual_maps_wo_conditioning_precipitation_nino4_con_everything
;
CREATE TABLE casual_maps_wo_conditioning_precipitation_nino4_con_everything
(longditude real,
laditude real,
...
\copy casual_maps_wo_conditioning_precipitation_nino4_con_everything (longditude,laditude,nino4_coefficient_minus_zero_lag,nino4_coefficient_minus_one_lag,nino4_coefficient_minus_two_lag, nino4_coefficient_minus_three_lag,nino4_coefficient_minus_four_lag,nino4_coefficient_minus_five_lag, nino4_coefficient_minus_six_lag, nino4_coefficient_minus_seven_lag,nino4_coefficient_minus_eight_lag, nino4_coefficient_minus_nine_lag, nino4_coefficient_minus_ten_lag, nino4_coefficient_minus_eleven_lag, nino4_coefficient_minus_twelve_lag) FROM 'C:/Users/Alexej/nino4_wo_conditioning.csv' DELIMITER ';';




--Casual maps for nino4 with maximum coefficients (lag (0) and 1-12) only 

DROP TABLE IF EXISTS beta_coefficients_maps_precipitation_nino4_wo_conditioning;
CREATE TABLE beta_coefficients_maps_precipitation_nino4_wo_conditioning as 
...
FROM casual_maps_wo_conditioning_precipitation_nino4_con_everything as b
GROUP BY b.longditude,b.laditude
ORDER BY b.laditude ASC,b.longditude ASC)
...
SELECT m.laditude,m.longditude,
	   ...
	   CASE WHEN m.maximum = 0 AND m.minimum = 0 THEN NULL
			...
			END as coefficient_lag
FROM maxmin as m, standardization as s, casual_maps_wo_conditioning_precipitation_nino4_con_everything as c  
WHERE m.laditude = s.laditude AND m.longditude = s.longditude AND m.longditude = c.longditude AND m.laditude = c.laditude
ORDER BY m.laditude ASC,m.longditude ASC;

SELECT b.coefficient_lag, count(*)
FROM (SELECT b.laditude,b.longditude,CASE WHEN abs(b.coefficients)>=0.1 THEN b.coefficient_lag ELSE NULL END as coefficient_lag FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning as b) as b
GROUP BY b.coefficient_lag
ORDER BY b.coefficient_lag;


\copy (SELECT b.laditude,b.longditude, b.coefficients FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino4_wo_conditioning.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients >= 0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients <= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino4_wo_conditioning_lag_red.csv' DELIMITER ';' CSV HEADER;
\copy (SELECT b.laditude,b.longditude, CASE WHEN b.coefficients <= -0.1 THEN b.coefficient_lag WHEN b.coefficients IS NULL OR b.coefficients >= 0 THEN NULL END FROM beta_coefficients_maps_precipitation_nino4_wo_conditioning as b ORDER BY b.laditude ASC,b.longditude ASC) TO 'C:/Users/Alexej/Desktop/Bachelorarbeit/climatology 1981-2010/PCMCI/causal_map_wo_conditioning/beta_coefficients_maps_precipitation_nino4_wo_conditioning_lag_blue.csv' DELIMITER ';' CSV HEADER;
